    ...
    try {
      ...
      if (response != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              response.sunkShip ? 'Ship sunk!' : 'No enemy ship hit',
            ),
          ),
        );
      }
                      ...
                      children: [
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return GestureDetector(
                                            onTap: () {
                                              if (gameProvider.gameDetails?.turn !=
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: gameProvider.gameDetails?.turn !=
                                        gameProvider.gameDetails?.position ||
                                    gameProvider.gameDetails?.status == 1 ||
                                    gameProvider.gameDetails?.status == 2 ||
                                    gameProvider.gameDetails?.status == 0
                                ? null
                                : () => submit(gameProvider.gameDetails!.id),
